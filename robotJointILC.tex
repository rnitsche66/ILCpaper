...
\end{itemize}
An excellent style manual for science writers is \cite{ILCGlueck2015}.
...
\bibliography{BibTeX_database_BC-DS_nitr}
...
% \bibitem{b3} I. S. Jacobs and C. P. Bean, ``Fine particles, thin films
%   and exchange anisotropy,'' in Magnetism, vol. III, G. T. Rado and
...
\vspace{12pt} \color{red} IEEE conference templates contain guidance
text for composing and formatting conference papers. Please ensure
that all template text is removed from your conference paper prior to
submission to the conference. Failure to remove the template text from
